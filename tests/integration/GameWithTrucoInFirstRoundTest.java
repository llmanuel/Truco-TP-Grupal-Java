...
public class GameWithTrucoInFirstRoundTest {
    ...
    @Test
    public void gameWithNoQuieroTrucoInSecondRoundTest() throws DonTHaveThatCardException, NotYourTurnException, NotCardThrownException, TeamDoesntExistException {
        this.table.setGame();
